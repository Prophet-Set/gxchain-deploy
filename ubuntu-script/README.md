...
| 软件更新 | 更新系统软件包<br />安装常用的软件包 | 1.apt-get update & upgrade<br />2.apt-get install -y iptables iptables-persistent libstdc++-7-dev<br /> unzip ntp htop zsh git-core software-properties-common |
